...
class VolumeEstimator():
    ...
    def predict_class(self, model, img_arr):
        ...
        # Convert the image array to the appropriate format
        img_array = img_arr.astype(np.uint8)  # Ensure data type is uint8
        img_array = np.squeeze(img_array)  # Remove single-dimensional entries from the shape of the array
